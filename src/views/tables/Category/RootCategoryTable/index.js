...
const RootCategoryTable = () => {
  ...
  async function updateCategory(id, type) {
    try {
      ...
      const param = {
        categoryId: id,
        subCategory: updateType === null ? type : updateType,
      };
  ...
  const createRootCategory = async () => {
    try {
      const params = { subCategory: rootCategoryType };
      ...
      >
        ...
        <Modal.Footer>
          ...
          <Button
            variant="primary"
            onClick={() =>
              updateCategory(selectedCategory.categoryId, updateType.type)
            }
          >
            Cập nhật
          </Button>
      ...
      >
        ...
        <Modal.Footer>
          ...
          <Button
            variant="primary"
            disabled={
              !(rootCategoryType.type !== undefined || rootCategoryType !== "")
            }
