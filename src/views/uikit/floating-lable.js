...
const FloatingLables = () => {
  ...
  return (
    ...
    <Form>
        <Form.Floating className=" mb-3">
            <Form.Control type="email" className="" id="floatingInput1" autoComplete="fullname email"  placeholder="name@example.com"/>
        ...
        <Form.Floating className="form-floating form-group mb-3">
            <Form.Control type="email" className="" disabled id="floatingInput2" autoComplete="fullname email" placeholder="Place Holder"/>
            <Form.Label htmlFor="floatingInput">Regular</Form.Label>
        </Form.Floating>
        <Form.Floating className="form-floating form-group mb-3">
            <Form.Control type="email" className="is-invalid" id="floatingInput3" autoComplete="fullname email" 
                placeholder="Place Holder"/>
            <Form.Label htmlFor="floatingInput">Regular</Form.Label>
        </Form.Floating>
        <Form.Floating className="form-floating form-group">
            <Form.Control type="email" className="is-invalid" id="floatingInput4" autoComplete="fullname email" 
                placeholder="Place Holder"/>
            <Form.Label htmlFor="floatingInput">Regular</Form.Label>
        </Form.Floating>
    </Form>
