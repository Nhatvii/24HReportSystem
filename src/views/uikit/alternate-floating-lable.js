          ...
          <Card className="">
            <Card.Body className="">
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/hope-ui/documentation/react/build/alternate-float-lable"
                  target="_blank"
                >
                  <svg
                    width="20"
                ...
                <div className="section-block">
                  <pre>
                    <code className="language-markup">
                      {`<div className="bd-example">
    <Form.Floating className=" custom-form-floating custom-form-floating-sm form-group mb-3">
        <Form.Control type="email" className="" id="floatingInput5" autoComplete="fullname email"  placeholder="Place Holder"/>
        <label htmlFor="floatingInput">Small</label>
    </Form.Floating>
    <Form.Floating className=" custom-form-floating form-group mb-3">
        <Form.Control type="email" className="" id="floatingInput6" autoComplete="fullname email"  placeholder="Place Holder"/>
        <label htmlFor="floatingInput">Regular</label>
    </Form.Floating>
    <Form.Floating className="custom-form-floating custom-form-floating-lg form-group mb-3">
        <Form.Control type="email" className="form-control" id="floatingInput7" autoComplete="fullname email" placeholder="Place Holder"/>
        <label htmlFor="floatingInput">Large</label>
    </Form.Floating>
    <Form.Floating className="custom-form-floating form-group mb-3">
        <Form.Control type="email" className="" disabled id="floatingInput8" autoComplete="fullname email" placeholder="Place Holder"/>
        <label htmlFor="floatingInput">Regular</label>
    </Form.Floating>
    <Form.Floating className=" custom-form-floating form-group mb-3">
        <Form.Control type="email" className="form-control is-valid" id="floatingInput" autoComplete="fullname email"  placeholder="Place Holder"/>
        <label htmlFor="floatingInput">Regular</label>
    </Form.Floating>
    <div className="form-floating custom-form-floating form-group mb-3">
        <Form.Control type="email" className=" is-invalid" id="floatingInput9" autoComplete="fullname email"  placeholder="Place Holder"/>
        <label htmlFor="floatingInput">Regular</label>
    </div>
</div>        
`}
