...
const AFormControls = () => {
  ...
  return (
          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/hope-ui/documentation/react/build/alternate-input"
                  target="_blank"
                >
                  <svg
                    width="20"
                ...
                <div className="bd-example">
                  ...
                  <Form.Group className=" input-group form-group-alt">
                    <Form.Control
                      ...
                      className=""
                      placeholder="Addon"
                      aria-label="Recipient's fullname"
    ...
    <Form.Group className=" input-group form-group-alt">
        ...
        <Form.Control type="text" className="" placeholder="Addon" aria-label="fullname" aria-describedby="basic-addon1"/>
    </Form.Group>
    <Form.Group className=" input-group form-group-alt">
        <Form.Control type="text" className="" placeholder="Addon" aria-label="Recipient's fullname" aria-describedby="basic-addon2"/>
