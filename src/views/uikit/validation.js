...
const Validations = () => {
  ...
  return (
              ...
              >
                <div className="bd-example">
                  <Form as={Row} className=" g-3">
                    ...
                    <Col md="4">
                      <Form.Label htmlFor="validationServerfullname">
                        fullname
                      </Form.Label>
    ...
    <Form as={Row} className=" g-3" >
        ...
        <Col md="4">
            <Form.Label htmlFor="validationServerfullname">fullname</Form.Label>
            <InputGroup hasValidation>
                <span className="input-group-text" id="inputGroupPrepend3">@</span>
                <Form.Control type="text" className=" is-invalid" id="validationServerfullname" aria-describedby="inputGroupPrepend3" required/>
                <Form.Control.Feedback type="invalid">
                    Please choose a fullname.
                </Form.Control.Feedback>
            </InputGroup>
