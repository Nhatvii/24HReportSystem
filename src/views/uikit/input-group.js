...
const Navs = () => {
  ...
  return (
                ...
                <div className="bd-example">
                  ...
                  <InputGroup className=" mb-3">
                    <Form.Control
                      type="text"
                      className=""
                      placeholder="Recipient's fullname"
    ...
    <InputGroup className=" mb-3">
        ...
        <Form.Control type="text" className="" placeholder="fullname" aria-label="fullname" aria-describedby="basic-addon1"/>
    </InputGroup>
    <InputGroup className=" mb-3">
        <Form.Control type="text" className="" placeholder="Recipient's fullname" aria-label="Recipient's fullname" aria-describedby="basic-addon2"/>
