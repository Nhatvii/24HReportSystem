...
async function logout() {
  try {
    ...
    localStorage.removeItem("user_notify");
  } catch (e) {
...
const Header = (props) => {
  ...
  useEffect(() => {
    if (
      ...
      localStorage.getItem("user_notify") &&
        setNotificationList(JSON.parse(localStorage.getItem("user_notify")));
    }
  }, [user_info]);
  return (
    <>
      <Navbar expand="lg" variant="light" className="nav iq-navbar">
        <Container fluid className="navbar-inner">
          <Link to="/dashboard" className="navbar-brand">
            <Logo />
            <h4 className="logo-title">24h Cảnh báo</h4>
          </Link>
          <div
              ...
              <Dropdown as="li" className="nav-item">
                ...
                >
                  <div className="notification">
                    ...
                    <span className="badge">{notificationList.length}</span>
                  </div>
                </Dropdown.Toggle>
                <Dropdown.Menu
                  ...
                  <div className="m-0 shadow-none card">
                    <div className="py-3 card-header d-flex justify-content-between bg-primary">
                      <div className="header-title">
                        <h5 className="mb-0 text-white">Tất cả thông báo</h5>
                      </div>
                    </div>
                      ...
                      {notificationList.length > 0 ? (
                        ...
                        <Link to="#" className="iq-sub-card">
                          <div className="d-flex align-items-center">
                            ...
                            />
                            <div className="ms-3 w-100">
                              <h6 className="mb-0 ">Không có thông báo</h6>
                            </div>
                          </div>
                        </Link>
                      )}
                ...
                >
                  ...
                  <div className="caption ms-3 d-none d-md-block ">
                    <h6 className="mb-0 caption-title">
                      {user_info && user_info.accountInfo.fullname}
                    </h6>
